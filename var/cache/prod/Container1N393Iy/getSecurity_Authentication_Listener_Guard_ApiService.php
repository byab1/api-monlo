 ...
 */
class getSecurity_Authentication_Listener_Guard_ApiService extends App_KernelProdContainer
{
    /*
    ...
    {
        $a = new \Symfony\Component\Security\Guard\GuardAuthenticatorHandler(($container->services['security.token_storage'] ?? $container->getSecurity_TokenStorageService()), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), [0 => 'registration', 1 => 'login', 2 => 'api']);
