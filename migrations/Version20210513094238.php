 ...
 */
final class Version20210513094238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE facture (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, montant_facture DOUBLE PRECISION NOT NULL, num_facture INT NOT NULL, apercu VARCHAR(191) DEFAULT NULL, statut_facture VARCHAR(191) NOT NULL, envoye_le DATETIME NOT NULL, modifie_le DATETIME DEFAULT NULL, INDEX IDX_FE866410A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, adresse VARCHAR(191) NOT NULL, telephone VARCHAR(191) NOT NULL, logo VARCHAR(191) NOT NULL, cote VARCHAR(191) NOT NULL, accreditation VARCHAR(191) NOT NULL, etat VARCHAR(191) NOT NULL, date_creation DATETIME DEFAULT NULL, date_modification DATETIME DEFAULT NULL, date_suppression DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
